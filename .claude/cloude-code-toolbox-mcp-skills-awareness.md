...
_Generated: 2026-08-02T15:47:32.209Z_
...
Workspace `mcp.json` _(folder: projeto-planilha-mobile)_

- **c:\Users\dbalb\Desktop\projeto-planilha-mobile\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\dbalb\.claude.json** — _File missing_
