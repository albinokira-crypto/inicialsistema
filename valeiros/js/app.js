    ...
    if (this.creatorStep === 'photo' && !isDmUser) {
      ...
      container.innerHTML = `
        <div class="creator-photo-step-container" style="display:flex; flex-direction:column; align-items:center; justify-content:center; width:100%; max-width:600px; margin:0 auto; padding:2rem; box-sizing:border-box;">
          ...
          <button class="rpg-btn" style="margin-top:2rem; width:100%; max-width:400px; height:50px; font-size:1.1rem; font-weight:bold; background:#5a3e09; color:#fdfaf2; border-color:#5a3e09; font-family:'Cinzel', serif; box-shadow:0 4px 10px rgba(90,62,9,0.3);" onclick="app.proceedToSheetCreator()">
            Preencher Ficha 📜
          </button>
        </div>
      `;
